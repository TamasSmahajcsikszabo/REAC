...
vignette: >
  %\VignetteIndexEntry{abvyr - Reaction Time Analytics in Attention Bias Research}
...
example1 <- abvyr::example
example2 <- abvyr::example2
...
The abvyr package provides tools for 
